...
def fetch_recent_emails_from_inbox(max_emails: int = 10) -> str:
    """
    Fetches the most recent unread emails (or all recent emails if there
    are no unread ones) from the user's Inbox.
    Returns a formatted summary list of emails including Sender, Date,
    Subject, and a content snippet.
    """
